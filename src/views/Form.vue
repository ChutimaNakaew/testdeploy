<template>
  <div id="app">
    <div class="container-fluid font my-3">
                ...
                <div class="col-12 mt-2">
                    ...
                    <div class="col-6">
                      ...
                      <span>
                        <p v-if="err.fname !== '' && firstname == ''">
                          <span class="ml-2" style="color:red;">{{ err.fname }}</span>
                        </p>
                      </span>
                    </div>
                    <div class="col-6">
                      ...
                      <span>
                        <p v-if="err.lname !== '' && lastname == ''">
                          <span class="ml-2" style="color:red;">{{ err.lname }}</span>
                        </p>
                      </span>
                    </div>
                  </div>
                    ...
                    <div class="col-6">
                      ...
                      <span>
                        <p v-if="err.phone !== '' && phone == ''">
                          <span class="ml-2" style="color:red;">{{ err.phone }}</span>
                        </p>
                      </span>
                    </div>
                    <div class="col-6">
                      ...
                      <span>
                        <p v-if="err.email !== '' && email == ''">
                          <span class="ml-2" style="color:red;">{{ err.email }}</span>
                        </p>
                      </span>
                    </div>
                  </div>
                  <div class="row mt-2">
                    <div class="col-12">
                      ...
                      <textarea name="annotation" value="" class="form-control" id="exampleFormControlTextarea1" rows="3"
                        v-model="annotaion"></textarea>
                    </div>
                  </div>
                  <div class="card my-3">
                    <div class="card-body">
                          ...
                          <div class="form-group">
                            ...
                            <span>
                              <p v-if="err.date !== '' && date == ''">
                                <span class="ml-2" style="color:red;">{{ err.date }}</span>
                              </p>
                            </span>
                          </div>
                        </div>
