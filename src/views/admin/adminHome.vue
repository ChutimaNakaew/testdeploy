              ...
              <div class="row">
                ...
                <div class="col-6 text-center">
                  <router-link to="/admin/login" class="text-decoration-none">
                    <div class="bg-danger text-white rounded-3">ออกจากระบบ</div></router-link>
                </div>
              </div>
              <div>
                <hr />
                  ...
                  <tr>
                    ...
                    <td>
                      <router-link class="btn btn-outline-primary"
                        :to="`/admin/info/${info._id}`">ดูรายละเอียด</router-link>
                    </td>
                  </tr>
                </tbody>
              </table>
