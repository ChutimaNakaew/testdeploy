  ...
  <div id="app">
    <div class="container p-3 font">
      ...
      <div class="row">
        ...
        <div class="col-2">
          <router-link class="btn btn-primary float-end" :to="`/statusUser`"><span>เช็คสถานะการจองทัวร์<i class="bi bi-check2-square ml-1"></i></span>
                        </router-link>
          ...
          <div class="col-4" v-for="tour in filteredTours" :key="tour.id">
            ...
            <div class="card-body my-2">
              ...
              <div class="text-end mb-3">
                <router-link class="btn btn-primary" :to="`/tour/${tour.name}`"
                  >รายละเอียดเพิ่มเติม
                </router-link>
              </div>
            </div>
