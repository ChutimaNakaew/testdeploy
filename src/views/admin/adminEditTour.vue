            ...
            <form @submit.prevent="submit">
              <div class="mb-3">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" readonly :value="details._id">
                </div>
              </div>
              ...
              <div class="mb-3">
                ...
                <textarea readonly v-if="schedule === ''" rows="6" type="text" class="form-control" name="schedule"
                  :value="details.schedule"></textarea>
              ...
              <div class="mb-3">
                ...
                <div class="input-group">
                  <b-form-datepicker v-if="date_first === ''" :value="details.date_first" name="date_first" class="mb-2"
              ...
              <div class="mb-3">
                ...
                <div class="input-group">
                  <b-form-datepicker v-if="date_second === ''" :value="details.date_second" name="date_second"
              ...
              <div class="mb-3">
                ...
                <div class="input-group">
                  <input v-if="img === ''" type="text" class="form-control" name="img" :value="details.img" readonly />
              ...
              <div class="mb-3">
                ...
                <div class="input-group">
                  <input v-if="detail_img === ''" type="text" class="form-control" name="detail_img"
                    :value="details.detail_img" readonly />
              ...
              <div class="mb-3">
                ...
                <div class="input-group">
                  <input v-if="max_tourist === 0" type="text" class="form-control" name="max_tourist"
                    :value="details.max_tourist" readonly />
...
export default {
  ...
  methods: {
    ...
    check() {
      ...
      if (this.province === "") {
        this.province = this.details.province
      }
      if (this.price === 0) {
      ...
      if (this.detail_img === "") {
        this.detail_img = this.details.detail_img
      }
      if (this.detail === "") {
        this.detail = this.details.detail
      }
      if (this.schedule === "") {
        this.schedule = this.details.schedule
      }
      if (this.max_tourist === 0) {
        this.max_tourist = this.details.max_tourist
      }
      if (this.date_first === "") {
        this.date_first = this.details.date_first
      }
      if (this.date_second === "") {
        this.date_second = this.details.date_second
      }
    },
    submit() {
      this.check()
