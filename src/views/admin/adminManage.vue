  ...
  <div class="container font">
    <section class="section" id="app">
      <div class="row">
        ...
        <div class="col-9" v-for="tour in tours.slice(0, 1)" :key="tour.id">
          <div class="card">
            <div class="card-content">
              <div class="content">
                ...
                <router-link class="fs-5 float-end  mr-2 btn btn-primary" :to="`/create/${tour.name}`"><span><i
                      class="bi bi-plus-circle"></i></span> เพิ่มทัวร์
                </router-link>
                <hr />
                <div class="row">
                  <div class="col-4" v-for="tour in tours" :key="tour.id">
                    ...
                    <div class="card-body my-2">
                      ...
                      <div class="text-right">
                        <router-link class="fs-4 text-black mr-2" :to="`/edit/${tour._id}`"><span><i
                              class="bi bi-pencil-square"></i></span>
                        </router-link>
                        <span class="ml-1 fs-4" @click="deleteTour(tour._id)"> <i class="bi bi-trash3"></i></span>
                      </div>
                    </div>
                  </div>
                </div>
